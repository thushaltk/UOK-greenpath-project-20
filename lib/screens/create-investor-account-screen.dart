...
class CreateInvestorAccountScreen extends StatefulWidget {
  static const routeName = '/create-account-investor';

  const CreateInvestorAccountScreen({Key? key}) : super(key: key);

  @override
  State<CreateInvestorAccountScreen> createState() => _CreateInvestorAccountScreenState();
}

class _CreateInvestorAccountScreenState extends State<CreateInvestorAccountScreen> {
    ...
    if (_passwordController.text != _confPasswordController.text) {
      ...
      try {
        await Provider.of<AuthService>(context, listen: false)
            .signupInvestor(_emailController.text, _passwordController.text);
